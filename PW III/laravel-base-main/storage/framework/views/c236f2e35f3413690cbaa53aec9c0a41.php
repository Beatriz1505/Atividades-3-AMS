...
<title>Login - The Black Parade</title>
...
<div class="flex justify-center pt-10 bg-[#141414] min-h-[calc(100vh-80px)] items-center">
  <div class="bg-[#700000] w-[350px] p-8 rounded-2xl shadow-lg text-center text-white">
    ...
    <h2 class="text-xl mb-6 font-[Creepster]">Welcome back to The Black Parade!</h2>
    ...
    <p class="font-[Creepster]">
      ...
      <a href="/register" class="text-[#FF0000] hover:underline">Sign up</a>
    </p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\laravel-base-main\resources\views/login.blade.php ENDPATH**/ ?>